...
/**
 * @param {{
 *  data: import('../../lib/fetch_types.js').BundlePhobiaData;
...
export function ModuleTreeMap({
  ...
  /** @type {ReturnType<typeof useState<JSX.Element[]>>} */
  ...
  useEffect(() => {
    ...
    const newLeaves = root.leaves().map((d, i, a) => {
       ...
       * @type {import('d3-hierarchy').HierarchyRectangularNode<import('../../lib/fetch_types.js').BundlePhobiaData['dependencySizes'][number]>}
       */
      const rd = d;
