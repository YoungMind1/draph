 ...
 * } & HTMLProps<SVGSVGElement>} IconProps
 */

/**
 * General SVG-based icon component path.
 * @returns {IconProps & SVGProps<SVGSVGElement>}
 */
 ...
 * @param {IconProps} props
 */
export function ZoomHorizontalIcon(props) {
  return (
    <Icon
 ...
 * @param {IconProps} props
 */
export function ZoomVerticalIcon(props) {
  return (
    <Icon
      name="zoom-vertical"
      {...props}
 ...
 * @param {IconProps} props
 */
export function OffsiteLinkIcon(props) {
  return (
    <Icon
      name="offsite-link"
      {...props}
